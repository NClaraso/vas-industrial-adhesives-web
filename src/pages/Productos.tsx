...
const industryProducts = [
  ...
  },
  {
    ...
    applications: [
      'Pañales y productos de incontinencia',
      'Productos femeninos',
      'Toallitas húmedas',
  ...
  },
  {
    ...
    applications: [
      ...
      'Montaje de componentes interiores',
      'Unión de textiles y espumas',
        ...
        <div className="container-custom">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-vas-muted/10 text-vas-muted mb-6">
              ...
              <span className="text-sm font-medium">Adhesivos por sector</span>
            </div>
          ...
          <div className="space-y-20">
            {industryProducts.map((industry, index) => (
              <section 
                key={industry.id} 
                id={industry.id}
                className={`pt-10 pb-10 ${industry.bgColor} rounded-lg`}
              >
                <div className="container-custom">
